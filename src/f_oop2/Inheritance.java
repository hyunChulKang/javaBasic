...
public class Inheritance {
	...
	public static void main(String[] args) {
		 ...
		 * -하나의 클래스만 상속받을 수 있다.
		 * -상속 받지 않은 모든 클래스는 Object 클래스를 상속받는다.
		 ...
		 * -자식 클래스 생성자의 첫줄은 super()가 있어야 한다.
		 * -없으면 컴파일러가 자동으로 추가한다.
		 * 
		 * <<오버 라이딩>>
		 * -상속받은 메서드의 내용을 재정의하는 것이다.
		 * -상속받는 메서드와 리턴타입, 메서드명, 파리미터가 있어야 한다.
		 * -상속받은 메서드보다 좋은범위의 접급제어자로 변경할 수 없다.
